...
/**
 * https://gist.github.com/DanielTheDev/cb51c11bd2551fd9a6700c582d12ff48
 * @author DanielTheDev
 * Modified by jamailun
 */
...
public class NmsNpc {
	 ...
	 */
	public NmsNpc(String name, Location location, Plugin plugin) {
		this.plugin = plugin;
		...
		this.dataWatcher.register(new DataWatcherObject<>(3, DataWatcherRegistry.i), false);
		this.dataWatcher.register(new DataWatcherObject<>(4, DataWatcherRegistry.i), false);
		this.dataWatcher.register(new DataWatcherObject<>(5, DataWatcherRegistry.i), false);
	...
	public void removeFromTabList() {
		...
		PacketPlayOutPlayerInfo.PlayerInfoData data = packet.new PlayerInfoData(this.gameprofile, 0, EnumGamemode.NOT_SET, CraftChatMessage.fromString(tablist_name)[0]);
	...
	private <T> void setDataWatcherObject(DataWatcherObject<T> datawatcherobject, Object t0) {
		try {
			Method m = this.dataWatcher.getClass().getDeclaredMethod("registerObject", DataWatcherObject.class, Object.class);
